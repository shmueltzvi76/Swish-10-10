...
const SPOTS = [
  ...
  // שלשות: על קשת אמיתית (חצי עיגול) ברדיוס 44 סביב מרכז X:50 Y:46 - עם רווח אמיתי מעיגול העונשין (שמגיע עד Y:80), לא משיקה אליו
  { id: 19, name: 'שלשה פינה שמאל', group: 'שלשות', x: 6, y: 46 },
  { id: 20, name: 'שלשה אמצע', group: 'שלשות', x: 50, y: 90 },
  { id: 21, name: 'שלשה פינה ימין', group: 'שלשות', x: 94, y: 46 }
];
          ...
          <div className="h-full flex flex-col p-4 animate-in fade-in">
            ...
            <div className="relative h-full max-w-full aspect-[4/5] bg-[#C28657] rounded-3xl border-[6px] border-white shadow-[0_10px_30px_rgba(0,0,0,0.5)] overflow-hidden">
              ...
              <svg viewBox="0 0 100 125" className="absolute inset-0 w-full h-full opacity-90 pointer-events-none">
                ...
                {/* קשת 3 - חצי עיגול אמיתי ברדיוס 44 סביב X:50 Y:46, עם רווח מלא מעיגול העונשין (מגיע עד Y:80) */}
                <path d="M 6 0 L 6 46 A 44 44 0 0 0 94 46 L 94 0" fill="none" stroke="white" strokeWidth="1.2" />
              </svg>
